...
\begin{document}
\parindent=1em
\title[IT for for Supporting Research of Large-scale Resource-driven DES Under Uncertainty]{Information Technologies for Supporting Research of Complex Large-scale Resource-driven Discrete-event Systems Under Uncertainty}
\author{
\def\and{, }
